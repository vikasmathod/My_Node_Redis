exports.Basic = (function () {
  ...
  basic = {},
  name = "Basic",
  client = "", tester = {}, server_pid = "", server_host = "", server_port = "", all_tests = "", client_pid = "";
  ...
  tester.Basic10 = function (errorCallback) {
    ...
    var cli = redis.createClient(server_port, server_host, { return_buffers: true });
    if (basic.debug_mode) {
  ...
  tester.basic71 = function (errorCallback) {
    ...
    var cli = redis.createClient(server_port, server_host, { no_ready_check: true });
    if (basic.debug_mode) {
      log.notice(name + ":Client connected  and listening on socket: " + server_host + ":" + server_port);
    }
    var e = new Array();
